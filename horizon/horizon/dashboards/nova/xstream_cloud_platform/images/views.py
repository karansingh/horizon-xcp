...
from horizon.dashboards.nova.xstream_cloud_platform.images.forms import \
...
#                            'nova/images_and_snapshots/images/index.html', {
                            'nova/xstream_cloud_platform/images/index.html', {
...
#                            'nova/images_and_snapshots/images/launch.html', {
                            'nova/xstream_cloud_platform/images/launch.html', {
                                'image': image,
                                'form': form,
                                'quotas': quotas})
...
#    return shortcuts.render(request, 'nova/images_and_snapshots/images/update.html', context)
    return shortcuts.render(request, 'nova/xstream_cloud_platform/images/update.html', context)
